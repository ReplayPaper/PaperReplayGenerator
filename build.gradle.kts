...
paperweight {
    serverProject.set(project(":PaperReplayGenerator-server"))
    ...
    usePaperUpstream(providers.gradleProperty("paperRef")) {
        withPaperPatcher {
            ...
            apiOutputDir.set(layout.projectDirectory.dir("PaperReplayGenerator-api"))

            serverPatchDir.set(layout.projectDirectory.dir("patches/server"))
            serverOutputDir.set(layout.projectDirectory.dir("PaperReplayGenerator-server"))
        }
    }
}
...
tasks.generateDevelopmentBundle {
    apiCoordinates.set("me.friwi:PaperReplayGenerator-api")
...
allprojects {
    // Publishing API:
    // ./gradlew :PaperReplayGenerator-API:publish[ToMavenLocal]
    publishing {
        repositories {
            maven {
